...
export class WindhappersDisciplines extends LitElement {
  ...
  updated(changedProperties) {
    const disciplineGallery = this.shadowRoot.querySelector(
      '#disciplineGallery'
    );
  ...
  render() {
    return html`
      ...
      ${cache(
        this._pages(this.routePrefix, this._disciplineId, this._response)
      )}
    `;
  }
  ...
  static _addItems(disciplineGallery, disciplines) {
